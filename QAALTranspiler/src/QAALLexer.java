...
public class QAALLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "Classical_op", "Transformation", 
			"Comment", "Swap", "NumExp", "Index", "Reg", "Bit", "Qubit", "Int", "Angle", 
			"Unit", "Bool", "Stop", "Operand", "Pi", "Bits", "Qubits", "Intlit", 
			"Keywords", "Idfr", "WS"
		};
	}
	...
	public QAALLexer(CharStream input) {
		super(input);
